...
export default ( stats ) => {
	...
	return {
		...
		pusher: [
			...
			{ type: "hospital", data: `${health} | 100`, label: "HEALTH", action: actions.self, text: "hospital", influence: "" },
			{ type: "storage", data: `${possession} | ${storage}`, label: "POSSESSION | STORAGE", action: actions.self, text: "storage", influence: "" },
